...
// In this piece of code we have implemented functional based component ,
//in place of class based component.
...
const App = (props) => {
  ...
  return (
    <div className="App">
      ...
      <RawLand
        name={rawLandState.rawLand[0].name}
        location={rawLandState.rawLand[0].location}
      />
      <RawLand
        name={rawLandState.rawLand[1].name}
        location={rawLandState.rawLand[0].location}
      />
      <RawLand
        name={rawLandState.rawLand[2].name}
        location={rawLandState.rawLand[0].location}
      />
      <RawLand
        name={rawLandState.rawLand[3].name}
        location={rawLandState.rawLand[0].location}
        click={switchNameHandler} >Circle Rate : 78000
       </RawLand>
    </div>
  );
};
